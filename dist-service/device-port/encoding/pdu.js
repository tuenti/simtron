...
var _pdu = _interopRequireDefault(require("pdu/pdu"));
...
const removeUnicodeNullChars = smsText => smsText.replace(_matcher.NULL_UNICODE_CHAR, '');

var _default = pduContent => {
  const decodedPdu = _pdu.default.parse(pduContent);

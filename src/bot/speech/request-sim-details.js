import {REQUEST_SIM_DETAILS} from '../model/message-type';
...
const getRequestDetailsMsisdn = messageText => {
...
const isRequestSimDetailsMessage = messageText => getRequestDetailsMsisdn(messageText) !== null;
export const createRequestSimDetails = () => ({
    messageType: REQUEST_SIM_DETAILS,
